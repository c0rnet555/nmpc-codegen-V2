...
def get_robot_model():
    number_of_states=3
    number_of_inputs=2
    indices_coordinates = [0,1] # at place 0 an 1 is x and y
    number_of_rect = 1
    number_of_circle = 0 
    robot_model = Robot_model()

    system_equations = lambda state, input: robot_model.system_equation(state, input)

    return (system_equations,number_of_states,number_of_inputs,indices_coordinates,number_of_rect,number_of_circle)
