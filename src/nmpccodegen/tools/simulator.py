...
class Simulator:
    ...
    def simulate_nmpc(self,current_state,state_reference,input_reference,rect_array,circle_array):
        """
        ...
        rect_array = rect_array.astype(np.float64)
        rect_array_p = rect_array.ctypes.data_as(c_double_p)
        
        circle_array = circle_array.astype(np.float64)
        circle_array_p = circle_array.ctypes.data_as(c_double_p)
