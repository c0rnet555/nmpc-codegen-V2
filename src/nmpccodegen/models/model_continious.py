...
class Model_continious(m.Model):
    ...
    """
    def __init__(self,system_equations,g,step_size,number_of_states,number_of_inputs,coordinates_indices,integrator,number_of_rect,number_of_circle):
        """
        Constructor Model
        ...
        Nothing
        """
        super(Model_continious,self).__init__(system_equations,g,step_size,number_of_states,number_of_inputs,coordinates_indices,number_of_rect,number_of_circle)
