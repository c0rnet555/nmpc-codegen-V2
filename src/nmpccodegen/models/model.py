class Model:
    ...
    """
    def __init__(self,system_equations,input_constraint,step_size,number_of_states,number_of_inputs,indices_coordinates,number_of_rect,number_of_circle):
        """
        Constructor Model
        ...
        self._number_of_rect=number_of_rect
        self._number_of_circle=number_of_circle
    ...
    @property
    def number_of_rect(self):
        """
        Get or set The dimension of the state.
        """
        return self._number_of_rect
    @number_of_rect.setter
    def number_of_rect(self, value):
        self._number_of_rect = value

    @property
    def number_of_circle(self):
        """
        Get or set The dimension of the state.
        """
        return self._number_of_circle
    @number_of_circle.setter
    def number_of_circle(self, value):
        self._number_of_circle = value
