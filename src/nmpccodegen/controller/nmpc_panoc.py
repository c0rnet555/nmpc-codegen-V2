...
class Nmpc_panoc:
    ...
    def generate_cost_constraints(self,state,input,constraint_weights):
		...
		# Evaluate_cost geeft normaal ook een casadi functie terug.. niet zeker hiervan
		# Staat in nmpccodgen/controller/obstacle en dan verdeeld over obstacle.py \\ polyhedral.py \\ rectangular.py
