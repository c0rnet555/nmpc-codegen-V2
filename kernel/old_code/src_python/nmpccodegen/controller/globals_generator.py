...
class Globals_generator:
    ...
    def generate_globals(self,nmpc_controller):
        ...
        self._define_variable("DIMENSION_PANOC", nmpc_controller.dimension_panoc)l
        self._define_variable("DIMENSION_RECT", nmpc_controller.model.number_of_rect)
        self._define_variable("DIMENSION_CIRCLE", nmpc_controller.model.number_of_circ)
