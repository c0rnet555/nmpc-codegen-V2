...
struct Panoc_time* simulate_nmpc_panoc( real_t* current_state,
                                        ...
                                        real_t* obstacles_rect,
                                        real_t* obstacles_circ,
                                        real_t* obstacles_nonconvex,
					real_t* obstacles_convex
                                        ){
    panoc_timer_start();

    int number_of_interations = npmc_solve(current_state,optimal_inputs,state_reference,input_reference,obstacles_rect,obstacles_circ,obstacles_nonconvex,obstacles_convex);
